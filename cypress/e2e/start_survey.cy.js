describe('Surveys', () => {
  it('should offer survey', () => {
    ...
    cy.get('@psResultsCard').find('.card-text').should('contain', '40.46');
    ...
    cy.get('@tmResultsCard').find('.card-text').should('contain', '-40');
    ...
    cy.get('@gmResultsCard').find('.card-text').should('contain', '37.55');
  })
})
